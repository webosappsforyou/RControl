...
/*    console.log("document.body.scrollLeft" + document.body.scrollLeft);
    ...
    console.log("evt.screenY" + evt.screenY);
    ...
    console.log(document.getElementById("omw_scrollpane1").clientLeft);
    console.log(document.getElementById("omw_scrollpane1").clientTop);
    console.log(document.getElementById("omw_scrollpane1").offsetLeft);
    console.log(document.getElementById("omw_scrollpane1").offsetTop);
    console.log(document.getElementById("omw_scrollpane1").scrollLeft);
    console.log(document.getElementById("omw_scrollpane1").scrollTop);*/
    //console.log(this.$.scroller.scrollTop);
    //console.log(this.$.scroller.scrollLeft);
    var shiftxy = getxyshift();
/*    console.log("Scrolled");
    console.log(shiftxy.x);
    console.log(shiftxy.y);
    console.log(docX);
    console.log(docY);
    console.log((shiftxy.x+ docX - pos.x) / scale);
    console.log((shiftxy.y + docY - pos.y) / scale); */
