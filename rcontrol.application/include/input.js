...
/*        console.log("Touch : " + bmask);
    ...
    if (bmask > 0 && conf.onMouseButton) {
        ...
        console.log("tttteestest");
        Util.Debug("onMouseButton " + (down ? "down" : "up") +
                   ", x: " + pos.x + ", y: " + pos.y + ", bmask: " + bmask + "scrollx: "  + scrollx + "scrolly: " + scrolly);
        conf.onMouseButton((pos.x+scrollx), (pos.y+scrolly), down, bmask);
    }
    Util.stopEvent(e);
    return false;
}
...
function onMouseDown(e) {
    onMouseButton(e, 1);
    mouseptr = e;
/*    console.log("mouseptr");
    console.log(mouseptr);
    console.log("mouseptr end");
    console.log("mouseptr.buttona");
    console.log(mouseptr.button);
    console.log("mouseptr.whicha");
    console.log(mouseptr.which);*/
}
...
//New public functions for right click - Shylendra
that.onMouseDown1 =  function () {
    console.log("Right Click button");
    console.log(mouseptr.button);
    console.log("Right Click mouseptr.which");
    console.log(mouseptr.which);

    mouseptr.button = "2";

    console.log("Right Click mouseptr.button again");
    console.log(mouseptr.button);
    onMouseButton1(mouseptr, 1);
    //mouseptr = e;
    console.log("Right Click mouseptr");
    console.log(mouseptr);
    console.log("Right Click mouseptr end");
}

that.onMouseUp1 = function () {
    console.log("Right Click mouseptr");
    mouseptr.button = 2;
    onMouseButton1(mouseptr, 0);
}

function onMouseButton1(e, down) {
    var evt, pos, bmask;
    console.log("Right Clickeeee");
    console.log(e);
    if (! conf.focused) {
        return true;
    }
...
//End - New public functions for right click - Shylendra
