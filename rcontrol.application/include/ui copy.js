...
enyo.kind({
        ...
        onSuccess: "good",
        onFailure: "bad",
        good: function(inSender, inResponse){console.log("WS-ed");},
        bad: function(inSender, inResponse){console.log("WS- Failed");}
});
//, 
/*{
  name: "proxify",
...
/*goodd: function(inSender, inResponse){
console.log("WS-ed");
},
badd: function(inSender, inResponse){
...
connect: function() {
   ...
   var lhostport = "localhost:" + port;
    // Shylendra
    host = "localhost";

   //WS Call - Shylendra
   // Call the Hello World service using standard webOS serviceRequest
   proxifys.call({sarg: lhostport,targ:hostport});
   console.log("proxifys done");
   /*"palm://com.palmdts.helloworld.service", {
       method: "hello",
       parameters: {"sarg": "localhost:6080","targ":"192.168.1.111:5900"},
       onSuccess:function(){console.log("WS-ed");},
       onFailure:function(){console.log("WS- Failed");}
   });
*/
